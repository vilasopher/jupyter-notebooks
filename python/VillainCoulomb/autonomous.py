...
for frame in tqdm(range(last_completed_frame+1, num_frames)):

    for round in tqdm(range(frame * iterations_per_frame, (frame+1) * iterations_per_frame), leave=False):
